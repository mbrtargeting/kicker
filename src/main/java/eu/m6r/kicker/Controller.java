...
public class Controller {
    ...
    public void motivate(final String slackChannelId) {
        ...
        try {
            ...
            // Parse JSON
            // Create reader was having issues reading directly from the input stream
            // (couldn't recognise it's charset)
            ...
            // Even if it is a suicide quote from Nietzsche :DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
